...
class TestSaleMrpLeadTime(TestStockCommon):
    ...
    def setUp(self):
        ...
        self.product_2.write({'type': 'product'})
    ...
    def test_00_product_company_level_delays(self):
        ...
        self.assertEqual(manufacturing_order.date_planned, mo_schedule_date, "Schedule date of manufacturing order should be equal to: Schedule date of picking - product's Manufacturing Lead Time - company's Manufacturing Lead Time.")
    ...
    def test_01_product_route_level_delays(self):
        ...
        mo_schedule_date = fields.Datetime.to_string(mo_date)
        self.assertEqual(manufacturing_order.date_planned, mo_schedule_date, "Schedule date of manufacturing order should be equal to: Schedule date of pack type picking - product's Manufacturing Lead Time.")
