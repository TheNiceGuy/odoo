...
class TestResource(TestResourceCommon):
    ...
    def test_00_intervals(self):
        ...
        cleaned_intervals = self.ResourceCalendar._model.interval_clean(intervals)
    ...
    def test_60_project(self):
        ...
        for resource in resources:
            ...
            self.assertEqual(float_compare(result, 9.0, precision_digits=2), 0, 'Wrong calculation of day work hour availability of the Resource (found %d).' % result)
