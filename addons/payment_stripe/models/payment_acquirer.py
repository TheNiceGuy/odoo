...
class PaymentAcquirerStripe(models.Model):
    ...
    stripe_image_url = fields.Char("Checkout Image URL",
        help="A relative or absolute URL pointing to a square image of your brand or product. "
        "As defined in your Stripe profile. See: https://stripe.com/docs/checkout")
