...
class PaymentAcquirerAuthorize(models.Model):
    ...
    def authorize_s2s_form_process(self, data):
        ...
        PaymentMethod = self.env['payment.method'].sudo().create(values)
...
class TxAuthorize(models.Model):
    ...
    def authorize_s2s_do_transaction(self, **data):
        ...
        tree = transaction.create_authorize_s2s_transaction(self.payment_method_id.acquirer_ref, self.payment_method_id.authorize_payment_id, self.amount, str(self.reference))
