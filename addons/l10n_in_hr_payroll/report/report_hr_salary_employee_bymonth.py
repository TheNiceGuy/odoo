...
#       Get name of the months from integer
    ...
    def get_employee(self, form, mnths, total_mnths):
        ...
        return salary_list, self.mnths_total
    ...
    def render_html(self, data):
        ...
        get_employee, mnths_total = self.get_employee(data['form'], months, total_mnths)
        get_months_tol = mnths_total
        get_total = self.get_total(mnths_total)
        docargs = {
            'doc_ids': self.ids,
            'doc_model': model,
            'data': data,
