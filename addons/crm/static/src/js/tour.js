...
tour.register('crm_tour', {
    ...
    content: _t("Let\'s create a new business opportunity."),
    position: "right"
}, {
    ...
    content: _t("<p><b>Send messages</b> to your prospect and get history of replies automatically attached to this opportunity.</p><p>Type <i>'@'</i> to mention people - it's like cc-ing on emails.</p>"),
    position: "top"
}, {
    trigger: ".breadcrumb li:not(.active):last",
    extra_trigger: '.o_opportunity_form',
    content: _t("Use the breadcrumbs to quickly <b>go back to your sales pipeline</b>."),
    position: "bottom"
}]);
