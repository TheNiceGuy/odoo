...
class MrpProductionWorkcenterLine(models.Model):
    ...
    def button_scrap(self):
        ...
        return {
            ...
            'context': {'default_workorder_id': self.id, 'default_production_id': self.production_id.id, 'product_ids': self.production_id.move_raw_ids.mapped('product_id').ids + [self.product_id.id]},
