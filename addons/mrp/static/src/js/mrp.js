...
var time_counter = common.AbstractField.extend(common.ReinitializeWidgetMixin, common.ReinitializeFieldMixin,{
    init: function(field_manager, node){
        this._super(field_manager, node);
    },
    start: function(){
    ...
    render_value: function() {
        ...
        var model = new Model('mrp.production.work.order.time').call('search_read', [domain, []]).then(function(result){
            self.result = result;
...
core.form_widget_registry.add('mrp_time_counter', time_counter);
});
