   ...
   # I check details of Produce Move of Production Order to trace Final Product.
    ...
    # I check Total Costs at End of Production as a manager.
        ...
        for workcenter_line in self.mrp_production_test1.workcenter_line_ids:
            ...
            accounts = [workcenter.analytic_account_id, workcenter.analytic_account_id]
            cost_per_cyle = workcenter_line.cycle * workcenter.costs_cycle
            cost_per_hours = workcenter_line.hour * workcenter.costs_hour
            if accounts and workcenter.analytic_account_id and (cost_per_cyle or cost_per_hours):
                ...
                for line in account_analytic_line.browse(line_ids):
                    if workcenter.analytic_account_id and line.account_id.id == workcenter.analytic_account_id.id:
                    ...
                    elif workcenter.analytic_account_id and line.account_id.id == workcenter.analytic_account_id.id:
                    ...
                    self.assertEqual(line.general_account_id.id, workcenter.analytic_account_id.id, "General Account is not correspond.")
