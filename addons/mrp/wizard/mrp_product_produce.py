...
class MrpProductProduceLine(models.TransientModel):
    ...
    track_production = fields.Boolean(string='Track Production', related='product_id.track_production')
...
class MrpProductProduce(models.TransientModel):
    ...
    def _get_track(self):
        ...
        return prod and self.env['product.product'].browse(prod).track_production or False
